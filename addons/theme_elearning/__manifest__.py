{
    ...
    'assets': {
        'web.assets_frontend':[
            ...
            'theme_elearning/static/src/scss/checkout.scss',
            ...
            'theme_elearning/static/src/js/checkout.js',
            'theme_elearning/static/src/js/add_to_cart.js',
            'theme_elearning/static/src/js/cart_widget.js',
